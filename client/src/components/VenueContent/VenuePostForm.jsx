      ...
      <div id='VenuePostForm'>
          ...
          <form  id='VenuePostFormDetails' className='Content'>
            ...
            <div id='VenuePostFormInput'>
              <input name='location' value={location} placeholder='desired location' onChange={props.handleChange} style={{width: '60%', display: 'flex', justifyVenue: 'center'}}/>
              <input name='date' value={date} placeholder='desired date' onChange={props.handleChange} style={{width: '60%', display: 'flex', justifyVenue: 'center'}}/>
