...
const Content = props => {
  ...
  switch (selectedNavButton) {
    ...
    case 'NavProfileButton':
      ...
      break;
    case 'NavPostButton':
      content = <BandPostPage userInfo={userInfo} handlePage={handlePage} page={page} handlePostFormChange={handlePostFormChange} postInfo={postInfo} handlePostSubmit={handlePostSubmit} handlePostView={handlePostView}/>
      break;
    case 'NavSurfButton':
      content = <PostGallery/>
      break;
