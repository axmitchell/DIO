...
const Content = props => {
  const { windowSize, page, userInfo, handlePage, selectedNavButton, handlePostFormChange, postInfo, handlePostSubmit, handlePostView, currentSurfPost, flipPost, otherUserPosts, postFront, handleSurfPostView, connections } = props;
  let content
